...
function whatis(obj, lowercase) {
    ...
    let result = Object.prototype.toString.call(obj).match(/\s([A-Za-z]+)/)[1];
...
function isNative(context) {
    ...
    const matches = Function.prototype.toString.call(context).match(
...
[
    ...
    dangit = (typeof module !== 'undefined' && module && module.exports) ?
            // Node.js.
            module.exports :
